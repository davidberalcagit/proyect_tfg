...
class StoreCarRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'id_listing_type' => 'required|exists:listing_types,id',
        ];
    }
        ...
        $validator->after(function ($validator) {
            if ($this->temp_brand) {
                ...
                if (Brands::where('nombre', 'LIKE', $tempBrand)->exists()) {
                    $validator->errors()->add('temp_brand', 'La marca "' . $tempBrand . '" ya existe.');
                }
            }
            ...
            if ($this->temp_color) {
                ...
                if (Color::where('nombre', 'LIKE', $tempColor)->exists()) {
                    $validator->errors()->add('temp_color', 'El color "' . $tempColor . '" ya existe.');
                }
            }
        });
    }

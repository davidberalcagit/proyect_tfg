                    ...
                    <form action="{{ route('cars.update', $car) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="grid grid-cols-1 gap-6">
                            <div>
                                ...
                                <input type="text" name="title" id="title" class="form-input rounded-md shadow-sm mt-1 block w-full" value="{{ old('title', $car->title) }}" />
                            </div>
                            <div>
                            ...
                            <div>
                                ...
                                <input type="text" name="color" id="color" class="form-input rounded-md shadow-sm mt-1 block w-full" value="{{ old('color', $car->color) }}" />
                            </div>
